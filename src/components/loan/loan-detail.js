    ...
    return <div>
        <form className="row g-3" onSubmit={handleSubmit}>
            <div className="col-md-6">
                <label htmlFor="borrower" className="form-label">Borrower</label>
                <input type="text" className="form-control" id="borrower" name="borrower" value={loanData.borrower || ""}
                    onChange={handleChange} />
            </div>
            <div className="col-md-6">
                <label htmlFor="lender" className="form-label">Lender</label>
                <input type="text" className="form-control" id="lender" name="lender" value={loanData.lender || ""}
                    onChange={handleChange} />
            </div>
            ...
            <div className="col-md-6">
                ...
                <div className="input-group">
                    <input type="number" className="form-control" id="loanAmount" name="loanAmount" value={loanData.loanAmount || ""}
                        onChange={handleChange} />
            ...
            <div className="col-md-6">
                ...
                <select id="status" name="status" className="form-select" value={loanData.status || ""}
            ...
            <div className="col-md-6">
                ...
                <div className="input-group">
                    <input type="number" className="form-control" id="interest" name="interest" value={loanData.interest || ""}
                        onChange={handleChange} />
            ...
            <div className="col-md-6">
                ...
                <select id="loanType" name="loanType" className="form-select" value={loanData.loanType || ""}
                    onChange={handleChange} aria-label="Default select">
                    <option value="1"></option>
            ...
            <div className="col-md-6">
                <label htmlFor="startDate" className="form-label">Loan Amount</label>
                <input type="date" className="form-control" id="startDate" name="startDate" value={loanData.startDate || ""}
                    onChange={handleChange} />
            </div>
            <div className="col-md-6">
                <label htmlFor="endDate" className="form-label">Lender</label>
                <input type="date" className="form-control" id="endDate" name="endDate" value={loanData.endDate || ""}
                    onChange={handleChange} />
            </div>
